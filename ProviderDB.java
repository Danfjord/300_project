...
//******************************************************
    ...
    public ProviderDB MakeProviderReport(int providernum, Date date) throws Exception {
        ProviderDB pr = new ProviderDB();
        ServiceContainer contain[] = ServiceDB.services_done_by_provider(providernum, date);
